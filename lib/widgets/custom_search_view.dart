...
class CustomSearchView extends StatelessWidget {
  CustomSearchView(
      ...
      this.filled = true,
      this.validator,
      this.onChanged, this.onClearTap,})
      : super(
          key: key,
        );
  ...
  InputDecoration get decoration => InputDecoration(
        ...
        prefixIcon: prefix ??
            Container(
              margin: EdgeInsets.fromLTRB(14.h, 10.h, 10.h, 10.h),
              child: CustomImageView(
                imagePath: Assets.images.search,
                height: 18.h,
                width: 18.h,
        ...
        fillColor: fillColor ?? appTheme.gray90001.withOpacity(0.62),
        filled: filled,
